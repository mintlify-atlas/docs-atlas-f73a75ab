---
title: "Run Social Media Backend locally for development setup"
sidebarTitle: "Local Setup"
description: "Set up the Social Media Backend on your local machine with PostgreSQL, configure environment variables, run Alembic migrations, and start the dev server."
---
