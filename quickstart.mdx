...
<Steps>
  ...
  <Step title="Install dependencies">
    Install the project dependencies using either **uv** (recommended — faster, lockfile-backed) or plain **pip**.
  ...
  <Step title="Login to get a token">
    ...
    Copy the value of `access_token` — you need it for all subsequent requests.
  </Step>
