---
title: "Social Media Backend REST API reference overview"
sidebarTitle: "Overview"
description: "Base URL, authentication scheme, request/response formats, and common error codes for the Social Media Backend REST API."
---
