...
sidebarTitle: "POST /posts/"
description: "POST /posts/ creates a new post owned by the authenticated user. Accepts title, content, and published flag. Returns the created post. Requires JWT authentication."
---
