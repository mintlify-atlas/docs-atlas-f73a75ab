---
title: "PUT /posts/{id} — replace an existing post by its ID"
sidebarTitle: "Update Post"
description: "PUT /posts/{id} replaces all fields of an existing post owned by the caller. Only the post owner may update it. Requires a valid JWT Bearer token."
---
